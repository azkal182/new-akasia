...
type FuelPurchase = Awaited<
  ReturnType<typeof getFuelPurchasesByHijriMonth>
>["purchases"][number];
type FuelByCar = Awaited<
  ReturnType<typeof getFuelPurchasesByHijriMonth>
>["fuelByCar"][number];
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        a.href = url;
        a.download = `Laporan-BBM-${hijriYear}-${hijriMonth}.pdf`;
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              {hijriMonths.find((m) => m.value === hijriMonth)?.label}{" "}
              {hijriYear}H
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-wrap items-end gap-4">
            <div className="space-y-1">
              ...
              <Select
                ...
                onValueChange={(v) => setHijriYear(parseInt(v))}
              >
            ...
            <div className="space-y-1">
              ...
              <Select
                ...
                onValueChange={(v) => setHijriMonth(parseInt(v))}
              >
